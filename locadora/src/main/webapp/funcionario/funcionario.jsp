...
<%@page import="br.com.model.dao.FilialDAO"%>
<%@page import="br.com.model.Filial"%>
                        ...
                        <form action="CadastrarFuncionario" method="post" name="formEditCad">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select  id="idFilial"  name= "idFilial" class="form-control">

                                        <c:forEach items="${filiasCadastradas}" var="filial">

                                            <option value="${filial.getNome()}" >${filial.getNome()}</option>
