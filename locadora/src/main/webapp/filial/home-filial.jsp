...
<jsp:include page="/util/topo.jsp"></jsp:include>
    ...
    <html>
            ...
            <div id="form" class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 d-flex-inline ">  
                        <a class="btn btn-primary btn-block" href="#" data-toggle="modal" data-target="#novaFilial" onclick="resetFormularioFilial()"> Nova Filial</a>  
                    </div>
                </div>
                <hr>
                <div class="col-md-12 d-flex-inline">  
                    <form action="buscarFi" method="post" class="form-inline my-2 my-lg-0 d-flex-inline" id="procura"> 
                ...
                <div class="col-md-12">
                    ...
                    <c:forEach items="${listarFilial}" var="filial">
                        <tr onclick="editarFilial(${filial.getId()})" id="trTable">
                            ...
                            <td>
                                <c:out value="${filial.getNome()}" />
                            </td>
                            <td>
                                <c:out value="${filial.getRua()}" />
                            </td>
                            <td>
                                <c:out value="${filial.getTelefonefixo()}" />
                            </td>
                            <td>
                                <c:out value="${filial.getTelefonecelular()}" />
                            </td>
                        </tr>
                    </c:forEach>
                </table>
        ...
        <div class="modal fade" id="novaFilial" tabindex="-1" role="dialog" aria-labelledby="modalFilial">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalFilial">Cadastrar Filial</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="filial" method="post" name="formEditFilial">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="complemento"  placeholder="ex: próximo ao bar do zé">
                                </div>
                                <div class="form-group col-md-6">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" onclick="excluirFilial()">Sim</button>
    ...
    <script src="JQuery/editar-filial.js" type="text/javascript"></script>
