 ...
 * @author jackson
 */
 //   @WebServlet(name = "ProdutoServlet", urlPatterns = {"/editado"})

@WebServlet(name = "EditarClient", urlPatterns = {"/edit"})
 ...
 */
                ...
                throws ServletException, IOException
    {
        ...
        c = cliente.Pesquisa(Integer.parseInt(request.getParameter("id")));
